...
export default function DataCenter() {
  return (
    <section
      className="py-24 mt-20"
      style={{
        background:
          "radial-gradient(34.06% 34.06% at 34.06% 50%, #085BDF 0%, #5D39D3 100%)",
      }}
    >
      <Container>
        <div className="flex justify-between lg:flex-row flex-col items-center">
          ...
          <div className="w-full lg:order-2 order-1 lg:w-1/2">
            <h2 className="text-white text-3xl lg:text-[34px] font-semibold font-beatrice leading-normal mb-4">
              Data Centers within the Reach your Visitors
            </h2>
            <p className="text-white text-base font-medium font-dmSans leading-normal">
              Across various domains, including software development, business
              strateg manufacturing, and service delivery. Here’s a
              comprehensive look at what adaptability large-scale operations.
            </p>
