...
export default function BlazingPerformance() {
    return (
        <svg width="325" height="264" viewBox="0 0 325 264" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.40932" y="0.40932" width="324.181" height="262.783" rx="24.1499" fill="url(#paint0_radial_105_1485)" stroke="url(#paint1_linear_105_1485)" stroke-width="0.81864"/>
            <defs>
                ...
                <linearGradient id="paint1_linear_105_1485" x1="325" y1="131.801" x2="0" y2="131.801" gradientUnits="userSpaceOnUse">
                    <stop offset="0.235" stop-color="#CFE5FF"/>
                    <stop offset="0.49" stop-color="#704FE4"/>
                    <stop offset="0.759503" stop-color="#CFE5FF"/>
                </linearGradient>
            </defs>
            </svg>
    )
