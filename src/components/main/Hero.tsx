    ...
    <div className="hero-Home w-full h-auto relative overflow-hidden">
      ...
      <Container className="min-h-[687px] p-0 relative flex items-start flex-col z-20">
        <div className="flex flex-col justify-between items-stretch w-full h-full text-center pt-28">
          <h1 className="font-medium font-beatrice text-center text-transparent bg-gradient-to-b from-[#6740E2] to-black text-5xl 2xl:text-6xl bg-clip-text leading-normal 2xl:leading-[80px] relative ">
          ...
          <div className="flex lg:flex-row flex-col justify-center items-center mt-7">
            <BlazingGrid
        ...
        <div className="review-container mt-12 pb-20 w-full flex xl:flex-row flex-col xl:justify-between justify-center">
          <div className="w-full xl:w-[70%] grid grid-flow-col gap-x-7 col-span-3">
            {Array.from({ length: 3 }).map((_, index) => {
              return <ReviewCard key={index} />;
            })}
          </div>
          <div className="xl:w-[30%] flex justify-center xl:flex-end items-center flex-row xl:flex-col xl:gap-0 gap-5 pt-5 xl:pt-0">
