...
import { FasterLoad, GlobalCDN, GuaranteeIcon, ProvenReliability } from '@/lib/constants'
...
const BlazingGrid = ({title , list, className} : BlazingGridProps) => {
    return (
        <div className={`relative ${className} ${list ? 'mr-14' : 'ml-14'}`}>
            ...
            {list ? (
                ...
                <Image width={40} height={40} src={GuaranteeIcon} alt="99.9% Uptime Guarantee"/>
                ...
                <Image width={40} height={40} src={FasterLoad} alt="99.9% Uptime Guarantee"/>
                ...
                <Image width={40} height={40} src={GlobalCDN} alt="99.9% Uptime Guarantee"/>
                <p>Global CDN for Local Speeds</p>
                </li>
                </ul>
            ) : (
                <Image className='mt-4' src={ProvenReliability} alt='Proven reliability' width={280} height={168} />
            )}
            </div>
        </div>
    )
